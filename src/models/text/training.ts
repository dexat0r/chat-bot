export default {
    ...
    results: {
        ...
        6: "Спасибо за Ваши ответы. Вы неплохо справились, но мой Вам совет – отвечать более развернуто, чтобы работодателю было на что опереться. Мы рассмотрим Вашу кандидатуру.",
